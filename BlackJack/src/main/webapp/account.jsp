		...
		<div class="card rounded-4 p-4">
			...
			<div class="table-responsive">
				<table id="partiteTable"
					class="table table-striped table-hover align-middle text-white">
					<thead>
						<tr>
							<th>Stato</th>
							<th>Punti Banco</th>
					...
					<tbody>
						...
						<tr>
							...
							<%
							if (partita.getStato().equals("In corso")) {
							%>
							<td>-</td>
							<%
							...
							%>
							<td><%=Format.format(partita.getDataInserimento())%></td>
							<td><%=Format.format(partita.getDataModifica())%></td>
							<td>
								<form method="POST"
